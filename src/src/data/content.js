...
export const benefitsSection = {
  ...
  courseSystem: {
    ...
    lines: [
      {
        name: "主线一【项目线】",
        content: "火种节、加速营、项目路演等"
      },
      {
        name: "主线二【创业线】",
        content: "创业导论、创业机会、创业团队等"
      },
      {
        name: "主线三【数字线】",
        content: "数创导论、产品设计、产品运营等"
      }
    ]
  }
};
